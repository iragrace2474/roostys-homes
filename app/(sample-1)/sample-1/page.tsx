        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-md-6 col-lg-3 mb-5">
              <div className="hotel-room text-center">
                <Link href="/sample-1/rooms" className="d-block mb-0 thumbnail">
                  <img src="/theme/images/img_3.jpg" alt="One Bedroom Occupancy" className="img-fluid" fetchPriority="high" decoding="sync" />
                </Link>
                <div className="hotel-room-body">
                  <h3 className="heading mb-0"><Link href="/sample-1/rooms">One Bedroom Occupancy</Link></h3>
            ...
            <div className="col-md-6 col-lg-3 mb-5">
              <div className="hotel-room text-center">
                ...
                <div className="hotel-room-body">
                  <h3 className="heading mb-0"><Link href="/sample-1/rooms">Deluxe Cottage</Link></h3>
                  <strong className="price">UGX 200,000 / per night</strong>
            ...
            <div className="col-md-6 col-lg-3 mb-5">
              <div className="hotel-room text-center">
                ...
                <div className="hotel-room-body">
                  <h3 className="heading mb-0"><Link href="/sample-1/rooms">Two Bedroom Occupancy</Link></h3>
            ...
            <div className="col-md-6 col-lg-3 mb-5">
              <div className="hotel-room text-center">
                ...
                <div className="hotel-room-body">
                  <h3 className="heading mb-0"><Link href="/sample-1/rooms">Family Suite</Link></h3>
          ...
          <div className="row">
            <div className="col-md-12 text-center">
              <Link href="/sample-1/rooms" className="btn btn-primary pill text-white px-4">
                View All Rooms
              </Link>
            </div>
          </div>
        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-md-5 ml-auto">
              ...
              <p>
                <Link href="/sample-1/about" className="text-uppercase">
